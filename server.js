...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://dalejmitchell.github.io');
  res.appendHeader('Access-Control-Allow-Origin', 'http://localhost:8080');
...
app.post('/api/send-email', (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
   service:'gmail',
    auth: {
      user: 'Djmitchell.profile@gmail.com',
      pass: 'grvusbisngvqwkpb',
    },
  });

  // Define the email options
  const mailOptions = {
    from: 'Djmitchell.profile@gmail.com',
    to: 'Dalejmitchell@icloud.com', // Replace with the recipient's email address
